...
macro(COPY_ASSETS TARGET_NAME SOURCE_PATH TARGET_PATH)
	FILE(GLOB resourcefiles RELATIVE "${SOURCE_PATH}" "${SOURCE_PATH}/*")
	MESSAGE(${resourcefiles})
	COPY_FILES("${TARGET_NAME}" "${resourcefiles}" "${SOURCE_PATH}" "${TARGET_PATH}")
endmacro()
