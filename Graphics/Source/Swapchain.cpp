...
void Swapchain::Create(DeviceContext& dev, VkSurfaceKHR surface, GLFWwindow* window, VkRenderPass renderPass) {
...
void Swapchain::Recreate(DeviceContext& dev, VkSurfaceKHR surface, GLFWwindow* window, VkRenderPass renderPass) {
    int w = 0, h = 0;
    while (w == 0 || h == 0) {
        glfwGetFramebufferSize(window, &w, &h);
        glfwWaitEvents();
